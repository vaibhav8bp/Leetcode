...
//    private final int[] directions = {-1, 0, +1};
//
//    private boolean canCross(int currentStonePosition, int finalStonePosition, int lastJump, Set<Integer> stonesSet, Map<String, Boolean> dp) {
//        if (currentStonePosition == finalStonePosition) {
//            return true;
//        }
//
//        String currentState = currentStonePosition + "-" + lastJump;
//
...
//            }
//
//            int newStonePosition = currentStonePosition + newJump;
//
//            if (stonesSet.contains(newStonePosition) && canCross(newStonePosition, finalStonePosition, newJump, stonesSet, dp)) {
...
//
//        for (Integer currentStone : stones) {
//            stonesSet.add(currentStone);
//        }
//
//        int firstStonePosition = stones[0];
//
//        if (!stonesSet.contains(firstStonePosition + 1)) {
//            return false;
//        }
//
//        Map<String, Boolean> dp = new HashMap<>();
//
//        return canCross(firstStonePosition + 1, stones[stones.length - 1], 1, stonesSet, dp);
//    }

//    private final int[] directions = {-1, 0, +1};
//
//    private boolean canCross(int currentStonePosition, int finalStonePosition, int lastJump, Set<Integer> stonesSet) {
//        if (currentStonePosition == finalStonePosition) {
//            return true;
//        }
//
...
//            int newStonePosition = currentStonePosition + newJump;
//
//            if (stonesSet.contains(newStonePosition) && canCross(newStonePosition, finalStonePosition, newJump, stonesSet)) {
//                return true;
//            }
//        }
//
...
//        }
//
//        return canCross(firstStonePosition + 1, stones[stones.length - 1], 1, stonesSet);
//    }
}
